...
noremap <silent>  f :call CocAction('format')
nmap  p <Plug>(coc-diagnostic-prev) 
nmap  n <Plug>(coc-diagnostic-next)
...
imap <silent>  <Plug>TComment_
cnoreabbr <expr> Reword reword#live#start()
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/pack/plugins/start/vim-one,~/.vim/pack/plugins/start/vim-javascript,~/.vim/pack/plugins/start/vim-instant-markdown,~/.vim/pack/plugins/start/vim-illuminate,~/.vim/pack/plugins/start/vim-gitgutter,~/.vim/pack/plugins/start/vim-fugitive,~/.vim/pack/plugins/start/vim-airline,~/.vim/pack/plugins/start/undotree,~/.vim/pack/plugins/start/tcomment_vim,~/.vim/pack/plugins/start/syntastic,~/.vim/pack/plugins/start/reword.vim,~/.vim/pack/plugins/start/onehalfdark,~/.vim/pack/plugins/start/fzf.vim,~/.vim/pack/plugins/start/fzf,~/.vim/pack/plugins/start/coc.nvim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,~/.vim/pack/plugins/start/vim-javascript/after,/usr/share/vim/vimfiles/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-snippets
set shiftwidth=4
